...
[Suggest edits](https://github.com/firecrawl/firecrawl-docs/edit/main/developer-guides/common-sites/amazon.mdx)[Raise issue](https://github.com/firecrawl/firecrawl-docs/issues/new?title=Issue%20on%20docs&body=Path:%20/developer-guides/common-sites/amazon)
[ Connect MCP Clients with OAuth Previous ](https://docs.firecrawl.dev/developer-guides/mcp-setup-guides/oauth)[ Scraping Etsy Next ](https://docs.firecrawl.dev/developer-guides/common-sites/etsy)
⌘I
