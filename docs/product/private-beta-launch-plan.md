...
|---|---|---|---|
| Hosted HTTP API for beta testers | Verified quickstart | `docs/product/hosted-api-quickstart-verification-2026-06-28.md` | Metered beta keys only; finite credits; no unlimited hosted crawling. |
...
1. Hosted API key generated by the tester or provisioned for an approved tester.
2. Claude/Codex skill instructions for agent-driven usage.
