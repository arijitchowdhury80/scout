...
| 3 | Hosted beta offer | Keep `$22` one-time hosted beta pass with finite credits | Protects hosting/browser/LLM economics and avoids unlimited crawling liability | Keep website/payment copy finite-credit; do not advertise unlimited hosted crawling |
...
3. Hosted beta: keep $22 finite-credit one-time beta pass.
