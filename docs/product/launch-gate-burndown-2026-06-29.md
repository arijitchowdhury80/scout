...
| Crawl4AI/lxml risk decision | Open | Security/business risk decision | Arijit | Approve limited private-beta exception or require clean audit first | `docs/security/dependency-audit-refresh-2026-06-29.md` |
