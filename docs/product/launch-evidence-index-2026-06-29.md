...
| Hosted economics | Documented | `docs/product/hosted-economics-and-usage-limits.md`; `docs/product/unit-economics-and-pricing-model-2026-06-29.md`; `docs/competetor-website-knowledge/market-pricing-refresh-2026-06-29.md` | Arbitrary `$22`/`$9` pricing is rejected, browser/rendered/LLM work is separately metered, unlimited hosted crawling is rejected, and the approved current beta pricing posture is recorded: `$0` card-backed beta setup plus `$10/$25/$100` pay-as-you-go standard-credit packages. | Live paid checkout and API-key email delivery still require Stripe and SMTP smoke verification before hosted SaaS is production-complete. |
| Founder decision records | Verified | `docs/product/founder-decision-record-SCOUT-DEC-20260629-02.md`; `docs/product/founder-decision-record-SCOUT-DEC-20260629-03.md`; `docs/product/founder-decision-record-SCOUT-DEC-20260629-04.md`; `docs/product/founder-decision-record-SCOUT-DEC-20260629-05.md` | Pricing posture, artifact-only registry policy, Docker publishing deferral, and Crawl4AI/lxml private-beta risk exception are recorded and validated. | These decisions do not close Stripe/SMTP live smoke, PyPI, GHCR, Docker Hub, or security-clean claims. |
| Stripe deterministic readiness | Deferred | `docs/product/stripe-test-mode-readiness-2026-06-29.md`; `scripts/scout-hosted-admin stripe-smoke` | Deterministic checkout, webhook, provisioning, and key-delivery logic has coverage; helper exists for real test-mode smoke. | Paid self-serve checkout remains blocked until Stripe/SMTP live smoke passes. |
...
| Public pricing and hosted usage limits | Closed | Unit-economics-derived `$10/$25/$100` pay-as-you-go standard-credit packages are approved for the current beta pricing posture. |
...
4. Configure Stripe/SMTP and run live smoke before claiming hosted checkout or API-key email delivery is production-complete.
