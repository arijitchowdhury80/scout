...
_PRIMARY_TARGETS: tuple[TargetMetadata, ...] = (
    TargetMetadata(
        ...
        use_cases=["company", "prism", "careers", "jobs", "news", "blogs", "docs", "research"],
    ),
    TargetMetadata(
        name="Constructor",
        segment=TargetSegment.PRIVATE_B2B_SAAS,
    ...
    TargetMetadata(
        ...
        use_cases=["company", "prism", "careers", "jobs", "products", "news", "blogs"],
    ...
    TargetMetadata(
        ...
        use_cases=["company", "prism", "investor", "careers", "jobs", "news", "blogs"],
    ),
    TargetMetadata(
        name="Home Depot",
        segment=TargetSegment.PUBLIC_COMPANY,
        primary_use="public retail, investor, careers, product catalog, news",
        use_cases=["company", "prism", "investor", "careers", "jobs", "products", "news", "blogs"],
    ...
    TargetMetadata(
        ...
        primary_use="travel company intel, careers, research, website-quality",
        use_cases=[
            "company",
            "prism",
            "investor",
...
_SECONDARY_TARGETS: tuple[TargetMetadata, ...] = (
    ...
    TargetMetadata(
        name="Intuit",
        segment=TargetSegment.SECONDARY,
        primary_use="optional public careers/jobs validation",
        use_cases=["company", "careers", "jobs", "investor", "news", "blogs"],
    ),
)
