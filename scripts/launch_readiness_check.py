#!/usr/bin/env python3
"""Report Scout private-beta and public-launch readiness from repository evidence."""
...
def _print_text_report(report: dict[str, Any]) -> None:
    ...
    if public_launch["status"] == "blocked":
        print("")
        print(
            "Verdict: controlled private beta can continue if limits are honored; public launch is blocked."
        )
